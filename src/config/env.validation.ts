...
export const envValidationSchema = Joi.object({
  ...
  FEATURE_REFERRALS_ENABLED: Joi.boolean().default(false),
  FEATURE_REFERRAL_ALLOWED_STUDENT_IDS: Joi.string().allow('').default(''),
  FEATURE_PARTNER_LEDGER_ENABLED: Joi.boolean().default(false),
  FEATURE_PARTNER_LEDGER_ALLOWED_USER_IDS: Joi.string().allow('').default(''),
  FEATURE_REPORT_EXPORTS_ENABLED: Joi.boolean().default(false),
