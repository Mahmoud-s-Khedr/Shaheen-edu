...
export class EntitlementsController {
  ...
  @Post(':id/revoke') @HttpCode(HttpStatus.OK) @ApiOperation({ summary: 'Revoke a student entitlement' }) @ApiOkResponse({ type: AdminEntitlementDto }) revoke(@CurrentUser() actor: RequestUser, @Param('id') id: string) { return this.service.revoke(actor, id); }
