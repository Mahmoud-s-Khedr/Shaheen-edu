...
export class AdminAllocationsQueryDto extends PaginationQueryDto {
  ...
  @ApiPropertyOptional({ enum: PartnerAllocationKind })
  @IsOptional()
  @IsEnum(PartnerAllocationKind)
  kind?: PartnerAllocationKind;
  @ApiPropertyOptional({ enum: PartnerAllocationState })
  @IsOptional()
  @IsEnum(PartnerAllocationState)
  state?: PartnerAllocationState;
  @ApiPropertyOptional()
  @IsOptional()
  @IsString()
...
export class CreateSettlementDto {
  ...
  @ApiProperty({ example: 'BANK-TRANSFER-20260823-001' })
  @IsString()
  @MaxLength(160)
...
export class AssignReconciliationDiscrepancyDto {
  @ApiProperty({
    description: 'Administrator user ID assigned to investigate.',
  })
  @IsString()
...
export class RebuildPublisherUsageRollupsDto {
  @ApiProperty({
    example: '2026-08-01',
    description: 'Inclusive Cairo calendar date.',
  })
  @IsDateString()
  from!: string;
  @ApiProperty({
  ...
  to!: string;
  @ApiPropertyOptional({
    description: 'Rebuild one publisher only; omit for all publishers.',
  })
  @IsOptional()
  @IsString()
