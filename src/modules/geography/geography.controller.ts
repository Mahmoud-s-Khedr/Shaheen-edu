...
export class GeographyController {
  ...
  @Get('governorates') @ApiOperation({ summary: 'List managed governorates and centers' }) @ApiOkResponse({ type: PaginatedGovernorateResponseDto }) list(@CurrentUser() _actor: RequestUser, @Query() query: GovernoratesQueryDto) { return this.service.listGovernorates(query); }
  @Post('governorates') @ApiOperation({ summary: 'Create a governorate' }) governorate(@CurrentUser() _actor: RequestUser, @Body() dto: GeographyNameDto) { return this.service.createGovernorate(dto); }
  @Post('governorates/:governorateId/centers') @ApiOperation({ summary: 'Create a center' }) center(@CurrentUser() _actor: RequestUser, @Param('governorateId') governorateId: string, @Body() dto: GeographyNameDto) { return this.service.createCenter(governorateId, dto); }
