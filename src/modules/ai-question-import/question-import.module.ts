...
@Module({ imports: [AssetsModule, AuditModule, QuestionBanksModule], controllers: [QuestionImportController], providers: [QuestionImportService, QuestionImportQueue, QuestionImportWorker, DocumentTextExtractor, OpenRouterQuestionImportClient], exports: [QuestionImportWorker] })
