...
export class PublisherAgreementsQueryDto extends PaginationQueryDto {
  @ApiPropertyOptional({
    default: false,
    description: 'Include ended agreements.',
  })
  @IsOptional()
...
export class AgreementTargetDto {
  @ApiPropertyOptional({
    example: 'course-id',
    description: 'Provide exactly one target ID.',
  })
  @IsOptional()
  @IsString()
  courseId?: string;
...
export class CreatePublisherAgreementDto extends AgreementTargetDto {
  @ApiProperty({ example: 'publisher-user-id' })
  @IsString()
  publisherUserId!: string;
  @ApiPropertyOptional({
    enum: [
      ReferralCommissionKind.PERCENTAGE,
      ReferralCommissionKind.FIXED_PER_SALE,
    ],
  })
  @IsOptional()
  @IsEnum(ReferralCommissionKind)
  payoutKind?: ReferralCommissionKind;
  @ApiPropertyOptional({ example: 2500, minimum: 0, maximum: 10_000 })
  @IsOptional()
  @IsInt()
  @Min(0)
  @Max(10_000)
  ...
  @IsString()
  currency?: string;
  @ApiPropertyOptional({ example: 'PUB-2026-001' })
  @IsOptional()
  @IsString()
  @MaxLength(120)
  contractReference?: string;
  @ApiPropertyOptional({ example: 'asset-id' })
  @IsOptional()
  @IsString()
...
export class UpdatePublisherAgreementDto {
  @ApiPropertyOptional({ example: 'publisher-user-id' })
  @IsOptional()
  @IsString()
  publisherUserId?: string;
  @ApiPropertyOptional({ example: 2500, minimum: 0, maximum: 10_000 })
...
export class ReplacePublisherAgreementDto extends CreatePublisherAgreementDto {
  @ApiPropertyOptional({
    description: 'Activate the new version in the same transaction.',
    default: true,
  })
  @IsOptional()
  @IsBoolean()
...
export class SetPricingDto {
  ...
  @ApiPropertyOptional({
    example: 15000,
    minimum: 0,
    description: 'Required when isPurchasable is true; omit otherwise.',
  })
  @ValidateIf((dto: SetPricingDto) => dto.isPurchasable)
  @IsInt()
  @Min(0)
  priceMinor?: number;
  @ApiPropertyOptional({
