...
export class LessonsController {
  ...
  publish(
    ...
    return this.lessonsService.publish(actor, id, dto);
  }
  ...
  archive(
    ...
    return this.lessonsService.archive(actor, id, dto);
  }
  ...
  restore(
    ...
    return this.lessonsService.restore(actor, id, dto);
  }
  ...
  delete(
    ...
    return this.lessonsService.delete(actor, id, dto);
  }
}
