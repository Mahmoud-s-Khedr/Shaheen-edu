...
> Domain-cutover update: 9 Sep 2026. The production API is served at
> `https://api.jibal-platform.com`.

## Completed

- Production backend deployed successfully.
- Public API is live with HTTPS at `https://api.jibal-platform.com`.
...
### Jibal hostname cutover

Completed on 9 Sep 2026. The production API is available at
`https://api.jibal-platform.com`; host Nginx proxies it to the private Compose
gateway at `127.0.0.1:13000`. The frontend deployment, verification, and
