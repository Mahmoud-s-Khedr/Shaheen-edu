...
Production API: https://api.jibal-platform.com/

Use a dedicated non-production environment for mutation-based acceptance
testing; the journey runner deliberately rejects production targets.
